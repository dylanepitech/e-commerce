          ...
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <a
                ...
                className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#639D87] hover:bg-[#1E4347]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <a
                ...
                className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#639D87] hover:bg-[#1E4347] 
                    "
              >
                <svg

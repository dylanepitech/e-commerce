        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            ...
            <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
              <a
                target="_blank"
                href="https://x.com/ArchiDecoHSV"
                className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#1E4347] hover:bg-[#639D87]"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
              ...
              <a
                target="_blank"
                href="https://www.instagram.com/archideco.fr/?hl=fr"
                className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#1E4347] hover:bg-[#639D87]
                    "
              >
                <svg
              ...
              <a
                target="_blank"
                href="https://www.facebook.com/archideco.immo"
                className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#1E4347] hover:bg-[#639D87]"
              >
                <svg
              ...
              <a
                target="_blank"
                href="https://www.youtube.com/channel/UC8hKM37vwJT8R9B3NPRzNVQ/feed"
                className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#1E4347] hover:bg-[#639D87]"
              >
                <svg

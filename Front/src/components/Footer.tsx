            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                    <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                        ...
                        <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Partenaire officiel de Mobalpa.</p>
                        <a href="#" className="py-2.5 px-5 h-9 block w-fit bg-[#639D87] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-[#1E4347] lg:mx-0">
                            Contactez-nous !
                        </a>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Navigation</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Accueil</a></li>
                            <li className="mb-6"><a href="/news" className=" text-gray-600 hover:text-gray-900">Actualités</a></li>
                            <li><a href="/about" className=" text-gray-600 hover:text-gray-900">Notre Histoire</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Produits</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="#" className="text-gray-600 hover:text-gray-900">Nos Cuisines</a></li>
                            <li className="mb-6"><a href="#" className=" text-gray-600 hover:text-gray-900">Gros électroménager</a></li>
                            <li><a href="#" className=" text-gray-600 hover:text-gray-900">Petit électroménager</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Aide et Support</h4>
                        <ul className="text-sm  transition-all duration-500">
                            <li className="mb-6"><a href="#" className="text-gray-600 hover:text-gray-900">Service Client</a></li>
                            <li className="mb-6"><a href="#" className=" text-gray-600 hover:text-gray-900">Conditions d'utilisation</a></li>
                            <li ><a href="#" className=" text-gray-600 hover:text-gray-900">Politique de confidentialité</a></li>
                        </ul>
                    </div>
                    <div className="lg:mx-auto text-left ">
                        <h4 className="text-lg text-gray-900 font-medium mb-7">Newsletter</h4>
                        <p className="text-sm text-gray-500 leading-6 mb-7">Recevez les dernières nouvelles de nous !</p>
                        <a href="#" className="flex items-center justify-center gap-2 bg-[#639D87] rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-white font-semibold transition-all duration-500 hover:bg-[#1E4347] hover:text-white">S'abonner
                            <svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.25 6L13.25 6M9.5 10.5L13.4697 6.53033C13.7197 6.28033 13.8447 6.15533 13.8447 6C13.8447 5.84467 13.7197 5.71967 13.4697 5.46967L9.5 1.5" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </a>
                    </div>
                </div>
                <div className="py-7 border-t border-gray-200">
                    <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                        <span className="text-sm text-gray-500 ">©<a href="#">ArchiDeco</a> 2024, tous droits réservés.</span>
                        <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                            <a target="_blank" href="https://x.com/ArchiDecoHSV" className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#639D87] hover:bg-[#1E4347]">
                            ...
                            <a target="_blank" href="https://www.instagram.com/archideco.fr/?hl=fr" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#639D87] hover:bg-[#1E4347] 
                    ">
                            ...
                            <a target="_blank" href="https://www.facebook.com/archideco.immo" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#639D87]  hover:bg-[#1E4347]">
                            ...
                            <a target="_blank" href="https://www.youtube.com/channel/UC8hKM37vwJT8R9B3NPRzNVQ/feed" className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#639D87] hover:bg-[#1E4347]">
